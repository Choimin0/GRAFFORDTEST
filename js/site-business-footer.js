...
var SITE_LEGAL_MODAL_CONTENT = {
  kr: {
    terms: {
      title: "이용약관",
      bodyHtml:
        "<p>본 이용약관은 예시 문구입니다. 실제 서비스 오픈 전에 법무 검토를 거쳐 전문 약관으로 교체해 주세요.</p>" +
        '<h3>제1조 (목적)</h3><p>이 약관은 GRAFFORD(이하 "사업자")가 운영하는 숙박 예약 관련 웹사이트 및 부대 서비스(이하 "서비스")의 이용과 관련하여 사업자와 이용자 간의 권리, 의무 및 책임사항을 규정함을 목적으로 합니다.</p>' +
