  ...
  kr: {
    ...
    privacy: {
      ...
      bodyHtml:
        ...
        "<h3>2. 개인정보의 제3자 제공 및 위탁에 관한 사항</h3><p>회사는 원활한 결제 및 서비스 제공을 위해 아래와 같이 개인정보 처리를 위탁하고 있으며, 위탁계약 체결 시 개인정보가 안전하게 관리될 수 있도록 필요한 사항을 규정하고 있습니다.<br /><br />• 결제 처리 위탁<br />　　◦ 수탁업체: 토스페이먼츠 (Toss Payments)<br />　　◦ 위탁 업무 내용: 신용카드 결제 인증 및 대금 결제, 환불 대행<br />　　◦ 보유 및 이용 기간: 회원 탈퇴 시 또는 위탁 계약 종료 시까지 (단, 관계 법령에 따른 보존 기간 적용)<br /><br />• 시스템 호스팅 위탁<br />　　◦ 수탁업체: Vercel<br />　　◦ 위탁 업무 내용: 웹사이트 호스팅 및 인프라 관리<br />　　◦ 보유 및 이용 기간: 서비스 이용 종료 시 혹은 위탁 계약 종료 시까지</p>" +
