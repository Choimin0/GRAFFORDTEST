  ...
  kr: {
    ...
    privacy: {
      ...
      bodyHtml:
        ...
        "<h3>1. 개인정보의 처리 목적, 항목 및 보유 기간</h3><p>회사는 예약 서비스 제공을 위해 필요한 최소한의 개인정보를 수집하고 있습니다. 수집된 개인정보는 고지된 목적 외의 용도로는 사용되지 않으며, 목적이 달성된 후에는 지체 없이 파기합니다. 단, 관계법령의 규정에 의하여 보존할 필요가 있는 경우 아래와 같이 법정 기간 동안 보관합니다.</p>" +
        "<h3>2. 개인정보의 제3자 제공 및 위탁에 관한 사항</h3><p>예약 접수·확인, 고객 응대, 서비스 품질 개선, 법령상 의무 이행, 분쟁 대응 등의 목적으로 이용됩니다.</p>" +
        "<h3>3. 개인정보의 파기절차 및 파기방법</h3><p>관련 법령(전자상거래 등에서의 소비자보호에 관한 법률 등)에 따른 보존 의무가 있는 경우 해당 기간까지 보관하며, 그 외에는 수집 목적 달성 후 지체 없이 파기합니다.</p>" +
        "<h3>4. 이용자의 권리 의무 및 그 행사방법</h3><p>이용자의 동의가 있거나 법령에 근거가 있는 경우에 한하여 제공할 수 있으며, 결제·예약 시스템 운영 등 필요한 범위에서 수탁사에 처리를 위탁할 수 있습니다. 위탁 시에는 위탁 업무 내용과 수탁자를 방침에 공개합니다.</p>" +
        "<h3>5. 개인정보의 안전성 확보 조치</h3><p>이용자는 개인정보 열람·정정·삭제·처리 정지 등을 요청할 수 있으며, 요청 방법은 고객센터 안내에 따릅니다.</p>" +
        "<h3>6. 개인정보 보호책임자</h3><p>개인정보의 분실·도난·유출·변조를 방지하기 위해 접근 권한 관리, 저장 시 암호화(해당 시), 접속 기록 보관 등 합리적인 조치를 취합니다.</p>" +
        "<h3>7. 개인정보 처리방침 변경에 관한 사항</h3><p>개인정보 보호와 관련한 문의는 웹사이트에 게시된 연락처로 연락해 주시기 바랍니다.</p>",
    },
  },
  en: {
    terms: {
